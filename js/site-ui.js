...
["💡 Ý tưởng mô phỏng: PGS.TS. Phan Anh Tú — Trường Kinh tế, ĐH Cần Thơ · Hiện thực hóa trong hệ sinh thái BizOn.", "💡 Simulation concept: Assoc. Prof. Dr. Phan Anh Tú — School of Economics, Can Tho University · Realized in the BizOn ecosystem."],
...
["Bãi biển", "Beach"],
["Trung tâm", "Downtown"],
["Khu nghệ thuật", "Arts district"],
["Nhà ga", "Train station"],
["Chợ thành phố", "City market"],
["Đại học", "University"],
["🔒 Chốt tuần này", "🔒 Lock in this week"],
["Chọn đủ Phương thức + Thực đơn + Địa điểm để chốt.", "Pick a Method + Menu + Location to lock in."],
...
["Vô địch Boomtown!", "Boomtown Champion!"],
["Á quân Boomtown — sát nút!", "Boomtown runner-up — so close!"],
...
["Bài học nào áp dụng được cho khởi nghiệp thật?", "Which lessons carry over to real startups?"]
  ...
  var SPECIAL = [
    { page: 'food-truck', sel: 'header p.text-sm', en: "You are the founder of a frozen-treats startup in <b>Boomtown</b>. Each week, pick <b>Method – Menu – Location</b>. Goal: the highest total revenue after 5 weeks. The secret is to <b>test fast, then scale at the right moment</b>." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(1)', en: "🚚 <b>Food Truck</b>: revenue <b>×3</b> — but menu &amp; location are locked for the whole week. For when you already <i>know</i> the winning formula." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(2)', en: "🛒 <b>Push cart</b>: ~1/3 the revenue — but it weaves everywhere and picks up <b>lots of market intel</b>. The experimenter's weapon." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(3)', en: "📊 <b>Research</b>: spend a full week not selling and receive <b>historical data</b> (directionally right, possibly outdated)." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(4)', en: "🎯 True demand for each <b>Menu × Location</b> pair is hidden — different every game. Weekly observation is your best clue." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(5)', en: "⚔️ <b>3 AI rivals</b> — Alpha Dynamics 🐺, Mekong Ventures 🐘, Star Clay Co. 🦚 — also sell frozen treats across Boomtown. Share a location and you <b>split the customers</b>!" },
    { page: 'food-truck', sel: '#ft-end ol li:nth-child(3)', en: "How did you balance <b>learning</b> (push cart) and <b>scaling</b> (food truck)?" },
    { page: 'food-truck', sel: '#ft-end ol + p', en: "💡 Core lesson: <b>test cheap and fast first</b> (prototype with the Push cart); only when the signal is clear do you <b>bet big</b> (Food Truck). Historical data is directional — direct observation is gold." },
