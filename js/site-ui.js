...
["🧺 Gánh Hàng Khởi Nghiệp", "🧺 Street Vendor Startup"],
["Gánh Hàng Khởi Nghiệp", "Street Vendor Startup"],
["Khởi nghiệp hàng rong ở thị trấn Bến Phù Sa: mỗi tuần chọn Phương thức – Món hàng – Địa điểm. Thử nghiệm bằng gánh hàng rong, nhân rộng bằng xe lưu động. Lấy cảm hứng từ bài giảng của PGS.TS. Phan Anh Tú (ĐH Cần Thơ).", "A street-vendor startup in the river town of Bến Phù Sa: each week pick Method – Product – Location. Test with the hawker's yoke, scale with the mobile cart. Inspired by the lectures of Assoc. Prof. Dr. Phan Anh Tú (Can Tho University)."],
["💡 Lấy cảm hứng từ bài giảng khởi nghiệp của PGS.TS. Phan Anh Tú (Trường Kinh tế, ĐH Cần Thơ) và bài toán «thăm dò – khai thác» kinh điển trong quản trị · Kịch bản, nhân vật và luật chơi do BizOn phát triển riêng.", "💡 Inspired by the entrepreneurship lectures of Assoc. Prof. Dr. Phan Anh Tú (School of Economics, Can Tho University) and the classic explore–exploit problem in management · Scenario, characters and rules developed originally by BizOn."],
...
["🧺 Gánh Hàng Khởi Nghiệp — kết quả lớp", "🧺 Street Vendor Startup — class results"],
...
["Bài học nào áp dụng được cho khởi nghiệp thật?", "Which lessons carry over to real startups?"]
  ...
  var SPECIAL = [
    { page: 'food-truck', sel: 'header p.text-sm', en: "You are the founder of a street-food startup in <b>Bến Phù Sa</b>, a riverside town in the Mekong Delta. Each week, pick <b>Method – Product – Location</b>. Goal: the highest total revenue after 5 weeks. The secret is to <b>test fast, then scale at the right moment</b>." },
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(1)', en: "🛵 <b>Mobile cart</b>: revenue <b>×3</b> — but product &amp; location are locked for the whole week. For when you already <i>know</i> the winning formula." },
    ...
    { page: 'food-truck', sel: '#ft-intro ul li:nth-child(5)', en: "⚔️ <b>3 AI rivals</b> — Alpha Dynamics 🐺, Mekong Ventures 🐘, Star Clay Co. 🦚 — also trade all over Bến Phù Sa. Share a location and you <b>split the customers</b>!" },
    { page: 'food-truck', sel: '#ft-end ol li:nth-child(3)', en: "How did you balance <b>learning</b> (street hawking) and <b>scaling</b> (mobile cart)?" },
    { page: 'food-truck', sel: '#ft-end ol + p', en: "💡 Core lesson: <b>test cheap and fast first</b> (prototype by street hawking); only when the signal is clear do you <b>bet big</b> (mobile cart). Historical data is directional — direct observation is gold." },
