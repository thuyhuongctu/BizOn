  ...
  div.innerHTML = `
    <div class="max-w-md mx-auto px-6 py-8 ${ev.shake ? 'animate-shake' : ''}">
      ...
      <div class="clay-raised p-3 mt-3 flex items-center gap-3">
        <img src="assets/character/anh-tu-tablet.png" alt="PGS.TS Phan Anh Tú" class="w-11 h-11 rounded-full object-cover shadow-clay shrink-0" style="object-position:50% 8%">
  ...
  div.innerHTML = `
    <div class="max-w-md mx-auto px-6 py-8 text-center">
      ...
      <div class="clay-raised p-3 mb-4 flex items-center gap-3 text-left">
        <img src="assets/character/anh-tu-welcome.png" alt="PGS.TS Phan Anh Tú" class="w-12 h-12 rounded-full object-cover shadow-clay shrink-0" style="object-position:50% 8%">
